...
본 프로젝트는 개인 포트폴리오 용도로 공개되었으며, 모든 소스코드와 기획 내용에 대한 저작권은 저작권자(본인)에게 있습니다.

### 🚫 무단 도용 및 상업적 이용 금지
- **라이선스 미부여:** 본 프로젝트는 어떠한 오픈소스 라이선스도 적용되지 않았습니다.
- **복제 및 배포 금지:** 저작권자의 서면 동의 없이 본 프로젝트의 일부 또는 전체를 복제, 수정, 배포하거나 자기 저작물인 양 게시하는 행위를 금지합니다.
- **상업적 활용 금지:** 본 프로젝트의 비즈니스 로직(이사 견적 산출 로직, 동행 매칭 알고리즘 등)을 상업적인 서비스에 무단으로 도용할 경우 저작권법에 따라 법적 책임을 물을 수 있습니다.
